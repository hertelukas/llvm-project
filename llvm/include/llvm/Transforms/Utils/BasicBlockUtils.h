...
/// \brief Create a new intermediate target block for a switch/callbr edge.
///
/// Create a new basic block between a switch or callbr instruction and one of
/// its successors. The new block replaces the original successor in the
/// terminator instruction and unconditionally branches to the original
/// successor. This is useful for normalizing control flow, e.g., when
/// transforming irreducible loops.
///
/// \param MultiBrBlock   block containing the switch or callbr instruction
